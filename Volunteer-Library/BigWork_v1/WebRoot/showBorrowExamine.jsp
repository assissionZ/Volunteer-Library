      ...
      <div class="row" >
        ...
        <div id="navbar-spy" class="col-sm-2">
            ...
            <% 
            	...
            	if(user_ty!=null && user_ty.equals("manager")){
            		...
            		out.print("<li class=\"active\"><a href=\"BorrowExamine\">借书审核</a></li>");
        ...
        %>
            ...
            <table align="center" width="80%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <h3 class="biaoti" colspan="3" align="center" height="60" >借书审核</h3>
     <br>
			 
			 <tr>
				<th style="text-align:center;" class="btbg font-center titfont">借书编号</th>
				...
				<th style="text-align:center;" class="btbg font-center titfont">借阅数量</th>
				<th style="text-align:center;" class="btbg font-center titfont">借阅状态</th>
				<th style="text-align:center;" class="btbg font-center titfont">同意申请</th>
				<th style="text-align:center;" class="btbg font-center titfont">申请时间</th>
            </tr>
            <c:forEach items="${borrowlist }" var="book" step="1" varStatus="i" >
           	<tr>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.borrow_id }"></c:out></td>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.user_id }"></c:out></td>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.borrow_book_name }"></c:out></td>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.borrow_book_author }"></c:out></td>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.borrow_book_num }"></c:out></td>
             ...
             <td align="center" style="width:10%; height:40px;" class="btbg font-center">
             	<a href="UpdateBorrowStatus?id=${book.borrow_id }&type=已完成">同意</a>
             </td>
             <td align="center" style="width:10%; height:40px;" class="btbg font-center"><c:out value="${book.borrow_time }"></c:out></td>
           	</tr>
       		</c:forEach>
    		</table>
