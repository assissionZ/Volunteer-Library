   ...
   <script type="text/javascript">
	...
	<table align="center" width="80%" border="0" cellspacing="0" cellpadding="0">
     ...
     <br>
	    	...
	    	<tr>
         		<th style="text-align:center;" class="btbg font-center titfont"><input type="checkbox" onclick="chooseAll(this)"/>书号</th>
	    	...
	    	begin="<%=page_count%>"  end="<%=page_size+page_count-1%>">
           	<tr>
             <td align="center" style="width:10%" class="btbg font-center"><input type="checkbox" name="select_book_id" value="${book.book_id }"/>${book.book_id }</td>
             
             <td align="center" style="width:10%" class="btbg font-center"><c:out value="${book.book_name }"></c:out></td>
             <td align="center" style="width:10%" class="btbg font-center"><c:out value="${book.book_author }"></c:out></td>
             <td align="center" style="width:10%" class="btbg font-center"><c:out value="${book.book_residual_number }"></c:out></td>
             <td align="center" style="width:10%" class="btbg font-center"><c:out value="${book.book_total_number }"></c:out></td>
             <td align="center" style="width:10%" class="btbg font-center"><input id="preborrow_number" type="text" placeholder="0" name="preborrow_number"></td>
             <% count++; %> 
           	</tr>
       		</c:forEach>
    	</table>
    	<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
      	  <tr>
            <td align="center" style="width:10%" class="btbg font-center"><input type="submit" value="加入预借清单"/></td>
            <td align="center" style="width:10%" class="btbg font-center"> &nbsp; 本页总共<%=count%>条 / 总共<%=list.size()%>条   &nbsp;   &nbsp;</td>
            <%  
			...
			<a href = "showBookList.jsp?page_current=1" >首页</a>  
			<a href = "showBookList.jsp?page_current=<%=page_current-1%>" >上一页</a>  
			<a href = "showBookList.jsp?page_current=<%=page_current+1>page_total?page_current:page_current+1%>" >下一页</a>  
			<a href = "showBookList.jsp?page_current=<%=page_total%>" >尾页</a>  
